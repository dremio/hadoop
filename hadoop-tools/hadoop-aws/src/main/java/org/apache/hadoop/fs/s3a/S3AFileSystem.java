...
public class S3AFileSystem extends FileSystem implements StreamCapabilities {
  ...
  */
  ...
  private boolean doOpenFileStatusCheck = true;
  private boolean doCreateFileStatusCheck = true;
  ...
  public void initialize(URI name, Configuration originalConf)
    ...
    LOG.debug(bucket + ": doCreateFileStatusCheck = " + doCreateFileStatusCheck);
    LOG.debug(bucket + ": doCreateFileStatusCheck = " + doOpenFileStatusCheck);
...
=======
    ...
    final S3AFileStatus fileStatus = doOpenFileStatusCheck ? (S3AFileStatus) getFileStatus(path) :
            S3AFileStatus.fromFileStatus(dummyFileStatus, Tristate.FALSE, null, null);
>>>>>>> 9b5e30d79ac... DX-18552: Make file status checks optional during create() and open()
