...
public class AbfsConfiguration{
  ...
  @BooleanConfigurationValidatorAnnotation(ConfigurationKey = FS_AZURE_DISABLE_IF_MATCH_WITH_READ,
      DefaultValue = DEFAULT_DISABLE_IF_MATCH_READ)
  private boolean disableIfMatchWithRead;
  ...
  public boolean getDisableIfMatchWithRead() {
    return this.disableIfMatchWithRead;
  }
