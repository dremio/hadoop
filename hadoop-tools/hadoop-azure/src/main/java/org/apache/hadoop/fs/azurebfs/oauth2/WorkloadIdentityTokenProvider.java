...
public class WorkloadIdentityTokenProvider extends AccessTokenProvider {
  ...
  private AzureADToken cachedToken;
  ...
  protected AzureADToken refreshToken() throws IOException {
    ...
    cachedToken = getTokenUsingJWTAssertion(clientAssertion);
  ...
  protected boolean isTokenAboutToExpire() {
    if (tokenFetchTime == -1 || AzureADAuthenticator.isTokenAboutToExpire(cachedToken)) {
      return true;
    }
