...
public class CommonConfigurationKeysPublic {
   ...
   * core-default.xml</a>
   */
  public static final String KMS_CLIENT_TOKEN_SERVICE_FORMAT_ENABLE_KEY =
          "hadoop.security.kms.client.token.service.format.enable";
  /** Default value is enabled. */
  public static final boolean KMS_CLIENT_TOKEN_SERVICE_FORMAT_ENABLE_DEFAULT = true;
